...
lang_dict = { 1 : "Hindi", 2 : "English"}

# Populate this dictionary with appropriate prompts that correspond with the ids from lang_dict.
# Example: Key = 1. Value = 'What is your name?'.
name_prompt_dict = { 1. : 'Apka Naam' , 2. : 'What is your name?'
}

# Populate this dictionary with appropriate prompts that correspond with the ids from lang_dict.
# Example: Key = 1. Value = 'Hello'.
greetings_dict = { 1. : "Hey" , 2. : "Hello"
}
...
def language_input() -> int:
    ...
    return int(input("Enter language choice: "))
...
def get_name_input(name_prompt_options: Dict[int, str], lang_choice: int) -> str:
    ...
    :return:
    """
    pass#return name_prompt_dict[]# remove pass statement and implement me
...
def name_input(name_prompt: str) -> str:
    ...
    """
    return input(name_prompt_dict)  # remove pass statement and implement me
...
def greet(name: str, greetings_options: Dict[int, str], lang_choice: int) -> None:
    ...
    :return:
    """
    print(input(name_input())) # remove pass statement and implement me
